              ...
              <div className="relative group" id='Judgements'>
                ...
                <div id='Judgements dropdown'
                  ...
                  <div className="p-4 rounded-md">
                    ...
                    <ul className="space-y-2">
                      <li><Link href="/judgements/arbitration-matter" className="dropdown-higlight block p-1 rounded hover:bg-gray-100">Arbitration matter</Link></li>
                      <li><Link href="/judgements/consumer-disputes" className="dropdown-higlight block p-1 rounded hover:bg-gray-100">Consumer Disputes</Link></li>
                      <li><Link href="/judgements/real-estate-disputes" className="dropdown-higlight block p-1 rounded hover:bg-gray-100">Real Estate Disputes</Link></li>
                      <li><Link href="/judgements/cyber-disputes" className="dropdown-higlight block p-1 rounded hover:bg-gray-100">Cyber Disputes</Link></li>
                      <li><Link href="/judgements/other-matter" className="dropdown-higlight block p-1 rounded hover:bg-gray-100">Other matter</Link></li>
                    </ul>
                  </div>
                </div>
              </div>
             ...
             <div className="pt-2 pb-3 space-y-1 px-4 max-h-[calc(100vh-60px)] overflow-y-auto">
              ...
              <div className="border-b border-blue-800 pb-1">
                ...
                <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                  ...
                  <div className="ml-4 mt-1 space-y-1 text-sm">
                    <Link href="/judgements/arbitration-matter" onClick={handleMobileLinkClick} className="block py-1 pl-2 border-l-2 border-orange-500 hover:bg-blue-800 rounded-r">Arbitration matter</Link>
                    <Link href="/judgements/consumer-disputes" onClick={handleMobileLinkClick} className="block py-1 pl-2 border-l-2 border-orange-500 hover:bg-blue-800 rounded-r">Consumer Disputes</Link>
                    <Link href="/judgements/real-estate-disputes" onClick={handleMobileLinkClick} className="block py-1 pl-2 border-l-2 border-orange-500 hover:bg-blue-800 rounded-r">Real Estate Disputes</Link>
                    <Link href="/judgements/cyber-disputes" onClick={handleMobileLinkClick} className="block py-1 pl-2 border-l-2 border-orange-500 hover:bg-blue-800 rounded-r">Cyber Disputes</Link>
                    <Link href="/judgements/other-matter" onClick={handleMobileLinkClick} className="block py-1 pl-2 border-l-2 border-orange-500 hover:bg-blue-800 rounded-r">Other matter</Link>
                  </div>
                </div>
              </div>
              {/* Judgements - END */}
